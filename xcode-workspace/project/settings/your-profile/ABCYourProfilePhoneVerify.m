...
@interface ABCYourProfilePhoneVerify()
	@property (nonatomic, strong) BlockYourProfilePhoneVerifyTap blockTap;
	@property (nonatomic) UIButton* button;
@end

@implementation ABCYourProfilePhoneVerify
