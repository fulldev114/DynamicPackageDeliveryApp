...
@interface ABCYourProfilePhonePin()
	@property (nonatomic, strong) BlockYourProfilePhonePinConfirm blockConfirm;
	@property (nonatomic, strong) BlockYourProfilePhonePinEditingEnd blockEditingEnd;
...
@implementation ABCYourProfilePhonePin
	...
	- (void) initialise {
		...
		[labelCheck setText:NSLocalizedString(@"PIN sent to your phone", nil)];
