...
@interface ABCAddressEditDanger()
	@property (nonatomic, strong) BlockAddressEditDanger block;
@end

@implementation ABCAddressEditDanger
	...
	- (void) initialise {
		...
		NSAttributedString* labelText = [[NSAttributedString alloc]
			initWithString:NSLocalizedString(@"Delete this delivery address", nil)
			attributes:@{
		...
		[arrow setImage:[UIImage imageNamed:@"settings-trash.png"]];
