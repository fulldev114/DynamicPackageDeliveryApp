...
@interface ABCSettingsProfile()
	@property (nonatomic, strong) BlockSettingsProfile block;
@end

@implementation ABCSettingsProfile
	...
	- (void) initialise {
		...
		NSAttributedString* labelText = [[NSAttributedString alloc]
			initWithString:NSLocalizedString(@"View/Update your profile", nil)
			attributes:@{
