...
@interface ABCSettingsDanger()
	@property (nonatomic, strong) BlockSettingsDanger block;
@end

@implementation ABCSettingsDanger
	...
	- (void) initialise {
		...
		NSAttributedString* labelText = [[NSAttributedString alloc]
			initWithString:NSLocalizedString(@"Delete your profile", nil)
			attributes:@{
