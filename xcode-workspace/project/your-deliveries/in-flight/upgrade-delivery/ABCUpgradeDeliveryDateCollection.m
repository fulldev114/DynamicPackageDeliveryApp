//
//  ABCUpgradeDeliveryDateCollection.m
//  your-dpd
//
...
#import "ABCUpgradeDeliveryDate.h"
#import "AppDelegate.h"

@interface ABCUpgradeDeliveryDateCollection()
	@property (nonatomic) NSArray* dataDateCollection;
	@property (nonatomic) NSUInteger radioSelectIndex;
@end

@implementation ABCUpgradeDeliveryDateCollection
	...
	- (UITableViewCell*)
		...
		ABCUpgradeDeliveryDate* view = [[ABCUpgradeDeliveryDate alloc]
	...
	-(UIView*)
		...
		[label setText:NSLocalizedString(@"Choose a date", nil)];
