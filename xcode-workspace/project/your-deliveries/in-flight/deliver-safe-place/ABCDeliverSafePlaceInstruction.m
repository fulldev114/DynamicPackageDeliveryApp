//
//  ABCDeliverSafePlaceInstruction.m
//  your-dpd
//
...
@interface ABCDeliverSafePlaceInstruction()
	@property (nonatomic) UITextView* textView;
@end

@implementation ABCDeliverSafePlaceInstruction
	...
	- (void) initialise {
		...
		[label setText:NSLocalizedString(@"Additional instructions for our driver:", nil)];
