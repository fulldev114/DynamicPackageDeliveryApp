...
@interface ABCDeliveryCompleteParcel()
	@property (nonatomic) ABCDataParcel* dataParcel;
@end

@implementation ABCDeliveryCompleteParcel
	...
	- (void) initialise {
		...
		[description setFrame:CGRectMake(
			[self SizePaddingLeft],
			[dispatcherName frame].origin.y + [dispatcherName frame].size.height,
