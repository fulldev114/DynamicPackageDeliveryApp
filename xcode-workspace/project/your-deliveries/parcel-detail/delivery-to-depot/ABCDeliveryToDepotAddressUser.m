//
//  ABCDeliveryToDepotAddressUser.m
//  your-dpd
//
...
@interface ABCDeliveryToDepotAddressUser()
	@property (nonatomic) ABCDataAddress* dataAddress;
@end

@implementation ABCDeliveryToDepotAddressUser
	...
	- (void) initialise {
		...
		ABCPin* pin = [[ABCPin alloc] initWithText:@"A"];
		[self addSubview:pin];
		[pin colourSet:[AppDelegate ColourAppGreen]];
...
/*		UILabel* labelTitle = [[UILabel alloc] init];
		...
		[labelTitle setText:NSLocalizedString(@"Your address", nil)];
...
//		CGSize labelTitleSize = [labelTitle sizeThatFits:sizeThatFits];
		...
		[labelAddress setFrame:CGRectMake(
			...
			([self sizeView].height - labelAddressSize.height) / 2.0f,//[AppDelegate SizePaddingFromSides] + labelTitleSize.height + [AppDelegate SizePaddingFromSidesThin],
